...
-DBUILD_SHARED_LIBS=0 -DCURL_STATIC_CRT=1 -DCURL_DISABLE_LDAP=1 -DCURL_USE_LIBSSH=0 -DCURL_USE_LIBSSH2=0"
	BUILD_OPTS="--config Release"
else
	export CMAKE_GENERATOR="Ninja"
  BUILD_CONFIG="-DCMAKE_BUILD_TYPE=Release -DBUILD_CURL_EXE=0 \
-DBUILD_SHARED_LIBS=0 -DCURL_DISABLE_LDAP=1 -DCURL_USE_LIBSSH=0 -DCURL_USE_LIBSSH2=0"
	BUILD_OPTS=""
fi
