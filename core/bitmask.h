...
// I really wanted to enable these only for 'unsigned' enums, but std::underlying_type
// always seems to return an unsigned type, so you get these for ALL enums until I explore further.
